...
4. 文件夹下载会保留目录结构。网络中断后，到“下载”页选择任务并点击“继续任务”。进行中的任务可暂停并移除，相关临时内容会一并清理；移除已完成记录不会删除下载好的文件。
